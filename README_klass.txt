...
* copyright 2015 onwards www.buymoodlethemes.com
...
Klass theme - Installation steps
================================

1) On your download pacakge, you will find theme_klass.zip

2) Unzip - theme_klass.zip, you will get folder 'klass'

3) Copy folder 'klass' and put into theme folder of your moodle system
...
8) By clicking "Continue" button on success page , you will get options to change the klass theme settings.
   You can modify the settings later too :-)


Steps to set klass theme as default theme for your moodle system
==================================================================
...
5) Then click "Use theme" button on "Klass theme"
